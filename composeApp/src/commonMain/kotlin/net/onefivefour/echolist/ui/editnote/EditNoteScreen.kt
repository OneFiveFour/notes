...
import echolist.composeapp.generated.resources.edit_note_placeholder
import echolist.composeapp.generated.resources.edit_note_title_edit
import echolist.composeapp.generated.resources.edit_note_title_new
...
fun EditNoteScreen(
    ...
    val title = if (noteId == null) {
        stringResource(Res.string.edit_note_title_new)
    } else {
        stringResource(Res.string.edit_note_title_edit)
    }
    ...
    Column(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                placeholder = {
                    Text(
                        text = stringResource(Res.string.edit_note_placeholder),
