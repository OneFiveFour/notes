...
import echolist.composeapp.generated.resources.check_box_unchecked
...
enum class MarkdownToolbarAction(
    ...
    CheckboxUnchecked("Todo", Res.drawable.check_box_unchecked),
    CheckboxChecked("Done", Res.drawable.check_box_checked),
