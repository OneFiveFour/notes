...
/**
 * Feature: file-add-button, Property 3: Edit note save callback is a no-op (idempotence)
 *
 * For any text content in the EditNoteScreen,
 * invoking the save callback should not change local text state.
