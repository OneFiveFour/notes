...
- [ ] 1. Domain Layer — Model & Scheduling Modifications
  - [ ] 1.1 Add `isNotificationEnabled` field to `MainTask` data class
  ...
  - [ ] 1.2 Add early-return guard in `scheduleTaskNotification`
  ...
  - [ ] 1.3 Create `NotificationPermissionChecker` interface
  ...
  - [ ] 1.4 Create `NotificationPermissionRequester` interface
  ...
  - [ ] 1.5 Write property tests for `scheduleTaskNotification` with `isNotificationEnabled=false`
