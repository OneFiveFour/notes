...
- [x] 1. Create the default string resource file
  - [x] 1.1 Create `composeApp/src/commonMain/composeResources/values/strings.xml` with all 17 string entries
...
- [x] 2. Extract Login Screen strings
  - [x] 2.1 Update `LoginScreen.kt` to use `stringResource()` for all 5 hardcoded strings
  ...
  - [x] 2.2 Update `LoginViewModel.kt` to use `getString()` for all 4 validation error strings
  ...
  - [x] 2.3 Write property test for LoginViewModel validation error strings
...
- [x] 3. Checkpoint - Ensure login screen builds and tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 4. Extract Edit Note Screen strings
  - [x] 4.1 Update `EditNoteScreen.kt` to use `stringResource()` for all 5 hardcoded strings
...
- [x] 5. Extract Edit Tasklist Screen strings
  - [x] 5.1 Update `EditTaskListScreen.kt` to use `stringResource()` for 3 screen-specific strings and reuse 2 shared keys
...
- [x] 6. Extract Home Screen strings
  - [x] 6.1 Update `titleFromPath()` and `buildBreadcrumbs()` to accept a `homeTitle` parameter
  ...
  - [x] 6.2 Update `HomeViewModel` to resolve `home_title` via `getString()` and pass it to `titleFromPath`/`buildBreadcrumbs`
  ...
  - [x] 6.3 Write property test for home title parameterization
...
- [x] 7. Final checkpoint - Verify no hardcoded UI strings remain
  - Ensure all tests pass, ask the user if questions arise.
